# Django settings for comidinha project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'comidinha',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'eresvmn_dwxpz)le-+_^mu=8fxr(ydppm%kqncsdlm=__&amp;hf4y'
...
ROOT_URLCONF = 'comidinha.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'comidinha.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    MAINAPP_TEMPLATE_PATH,
)
